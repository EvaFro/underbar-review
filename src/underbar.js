(function() {
  ...
  // covert the array with the iterator - newArray
  // create a resultArray
  // create a checkArray
  // iterate over newArray
    // check to see if each element is in checkArray
    // if no -  push array[element] to resultArray
    // if no -  push newArray[element] to checkArray
  // return resultArray
  ...
  _.every = function(collection, iterator) {
    ...
    // find if any element in the colection is false
    // iterate over every element - test iterator
    // if false return false
    // else return true
    
    return _.reduce(collection, function(a, b) {
      if (iterator === undefined && a && b) { return true; }
  ...
  _.some = function(collection, iterator) {
    ...
    return !_.every(collection, function(a, b) {
      return !iterator(a, b);
    });
  };
  ...
  _.shuffle = function(array) {
    ...
    var holdValue;
    while (index) {
      switchIndex = Math.floor(Math.random() * index);
      index -= 1;
      holdValue = newArray[index];
      newArray[index] = newArray[switchIndex];
      newArray[switchIndex] = holdValue;
    }
    return newArray;
  };
